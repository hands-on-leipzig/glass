  ...
  <div ref="mapWrap" class="venues-map-wrap">
    ...
    >
      ...
      <div class="venues-map-legend-block">
        ...
        <ul class="venues-map-legend-list">
          ...
          >
            ...
            <span class="venues-map-legend-text">{{ t(`venues.offerShort.${o}`) }}</span>
      ...
      <div class="venues-map-legend-block">
        ...
        <ul class="venues-map-legend-list">
          ...
          >
            ...
            <span class="venues-map-legend-text">{{ t(`venues.country.${c}`) }}</span>
      ...
      <p v-if="resultCount != null" class="venues-map-legend-footer">
        {{ t('venues.resultsCount', { count: resultCount }) }}
      </p>
      </div>
    </div>
  </div>
